...
class TestAddUser(unittest.TestCase):
    ...
    def add_user_info(self, wd, user):
        ...
        wd.find_element_by_name("nickname").send_keys(user.nick)
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys(user.email)
        wd.find_element_by_css_selector("option[value=" + "'" + str(user.day) + "'" + "]").click()
        wd.find_element_by_name("bmonth").click()
        wd.find_element_by_css_selector("option[value=" + month_book[user.month] + "]").click()
        wd.find_element_by_name("byear").clear()
        wd.find_element_by_name("byear").send_keys(user.year)
